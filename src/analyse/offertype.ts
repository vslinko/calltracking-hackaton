...
const wordsMapping: { [key: string]: string[] | undefined } = {
  business: ['бизнес'],
  cottage: ['коттедж'],
  daily: ['сутки', 'суток', 'суточно', 'посуточно'],
  flat: ['квартира'],
  garage: ['гараж'],
  house: ['дом'],
  land: ['участок', 'земля'],
  newBuildingFlat: ['новостойка', 'квартира'],
  office: ['офис'],
  room: ['комната'],
  shoppingArea: ['торговая', 'площадь'],
  townhouse: ['таунхаус', 'таун', 'хаус', 'дом'],
  warehouse: ['склад', 'хранилище'],
};

export function analyseOfferType(
  call: IEnhancedCall,
  ...
  const distanceToStreet =
    features.distanceFromOfferTypeToStreet && analysis.street
